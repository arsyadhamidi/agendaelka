        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('data-akademik.index') }}" class="btn btn-primary">
                        <i class="bx bx-left-arrow-alt"></i>
                        Kembali
                    </a>
                    <a href="{{ route('data-akademik.create', $dosens->id) }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($akademiks as $data)
                                <tr>
                                    ...
                                    <td>{{ $data->tahun ?? '-' }}</td>
                                    <td>
                                        <form action="{{ route('data-akademik.destroy', $data->id) }}" method="POST"
                                            class="d-flex flex-wrap">
                                            @csrf
                                            <a href="{{ route('data-akademik.edit', $data->id) }}"
