            ...
            <div class="card">
                <div class="card-header d-flex align-content-center justify-content-between">
                    <div class="form-group">
                        <a href="{{ route('data-studilanjut.tahun', $tahuns->prodi_id) }}" class="btn btn-primary">
                            <i class="bx bx-left-arrow-alt"></i>
                            Kembali
                        </a>
                        <a href="{{ route('data-studilanjut.create', $tahuns->id) }}" class="btn btn-primary">
                            <i class="bx bx-plus"></i>
                            Tambahkan Studi Lanjut
                        </a>
                    </div>
                    <a href="{{ route('data-studilanjut.generateexcel', $tahuns->id) }}" class="btn btn-success"
                        target="_blank">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (!empty($data->berkas))
                                            <a href="{{ asset('storage/' . $data->berkas) }}" class="btn btn-primary"
                                                target="_blank">
                                                <i class="bx bx-download"></i>
                                                Download
                                            </a>
                                    ...
                                    <td>
                                        <form action="{{ route('data-studilanjut.destroy', $data->id) }}" method="POST"
                                            class="d-flex flex-wrap">
                                            @csrf
                                            <a href="{{ route('data-studilanjut.edit', $data->id) }}"
