...
@section('content')
    <div class="row">
        <div class="col-lg">
            <form action="{{ route('data-seminar.update', $seminars->id) }}" method="POST">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('data-seminar.seminar', $seminars->tahun_id) }}" class="btn btn-primary">
                            ...
                            <div class="col-lg">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="tahun"
                                        ...
                                        value="{{ old('tahun', $seminars->tahun ?? '-') }}" placeholder="Masukan tahun">
                                    @error('tahun')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
