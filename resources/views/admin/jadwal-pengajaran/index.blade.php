        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('data-jadwalpengajaran.create') }}" class="btn btn-primary">
                        <i class="bx bx-plus"></i>
                        Tambahkan Jadwal Pengajaran
                    </a>
                </div>
                        ...
                        <tbody>
                            @foreach ($jadwals as $data)
                                <tr>
                                    ...
                                    <td>{{ $data->semester ?? '-' }}</td>
                                    <td>
                                        <form action="{{ route('data-jadwalpengajaran.destroy', $data->id) }}"
                                            method="POST" class="d-flex flex-wrap">
                                            @csrf
                                            <a href="{{ route('data-jadwalpengajaran.edit', $data->id) }}"
