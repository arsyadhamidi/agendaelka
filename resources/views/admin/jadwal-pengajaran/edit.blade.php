...
@section('menuDataJadwalPengajaran', 'active')
@section('content')
    <div class="row">
        <div class="col-lg">
            <form action="{{ route('data-jadwalpengajaran.update', $jadwals->id) }}" method="POST"
                enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('data-jadwalpengajaran.index') }}" class="btn btn-primary">
                            ...
                            <div class="col-lg">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="semester" class="form-control @error('semester') is-invalid @enderror"
                                        ...
                                        <option value="Ganjil" {{ $jadwals->semester == 'Ganjil' ? 'selected' : '' }}>Ganjil
                                        </option>
                                        <option value="Genap" {{ $jadwals->semester == 'Genap' ? 'selected' : '' }}>Genap
                                        </option>
                                    </select>
                                    @error('semester')
                                        <div class="invalid-feedback">
