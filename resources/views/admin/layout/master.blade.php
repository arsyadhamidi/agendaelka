            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="/dashboard" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bolder ms-2">Agenda Elka</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    <!-- Dashboard -->
                    <li class="menu-item @yield('menuDashboard')">
                    ...
                    @if (Auth()->user()->level_id == '1')
                        ...
                        <li class="menu-item @yield('menuDataMaster')">
                            ...
                            <ul class="menu-sub">
                                ...
                                {{-- <li class="menu-item @yield('menuDataMatkul')">
                                    <a href="{{ route('data-matkul.index') }}" class="menu-link">
                                        <div data-i18n="Without menu">Data Matkul</div>
                                    </a>
                                </li> --}}
                                ...
                                <li class="menu-item @yield('menuDataDosen')">
                        ...
                        <!-- Akademik -->
                        <li class="menu-item @yield('menuDataAkademik')">
                            <a href="{{ route('data-akademik.index') }}" class="menu-link">
                        ...
                        <li class="menu-item @yield('menuDataNonAkademik')">
                            ...
                            <ul class="menu-sub">
                                ...
                                <li class="menu-item @yield('menuDataStudiLanjut')">
                                    <a href="{{ route('data-studilanjut.index') }}" class="menu-link">
                        ...
                        <li class="menu-item @yield('menuStatusAutentikasi')">
                            <a href="javascript:void(0);" class="menu-link menu-toggle">
                                ...
                                <div data-i18n="Layouts">Status Autentikasi</div>
                            </a>

                            <ul class="menu-sub">
                                <li class="menu-item @yield('menuDataAutentikasi')">
                                    <a href="{{ route('data-level.index') }}" class="menu-link">
                                        <div data-i18n="Without menu">Data Autentikasi</div>
                                    </a>
                                </li>
                                <li class="menu-item @yield('menuUserRegistrasi')">
                                    <a href="{{ route('data-user.index') }}" class="menu-link">
                                        <div data-i18n="Without menu">Users Registrasi</div>
                                    </a>
                                </li>
                            </ul>
                        </li>
                    @elseif (Auth()->user()->level_id == '3')
                        ...
                        <!-- Data Non Akademik -->
                        <li class="menu-item @yield('menuKepalaNonAkademik')">
                            <a href="javascript:void(0);" class="menu-link menu-toggle">
                                <i class="menu-icon tf-icons bx bx-qr"></i>
                                <div data-i18n="Layouts">Non Akademik</div>
                            </a>
                            ...
                            <ul class="menu-sub">
                                <li class="menu-item @yield('menuKepalaPenelitian')">
                                    <a href="{{ route('kepala-penelitian.index') }}" class="menu-link">
                                        <div data-i18n="Without menu">Data Penelitian</div>
                                    </a>
                                </li>
                                <li class="menu-item @yield('menuKepalaPengabdian')">
                                    <a href="{{ route('kepala-pengabdian.index') }}" class="menu-link">
                                        <div data-i18n="Without menu">Pengabdian Masyarakat</div>
                                    </a>
                                </li>
                                <li class="menu-item @yield('menuKepalaPublikasi')">
                                    <a href="{{ route('kepala-publikasi.index') }}" class="menu-link">
                                        <div data-i18n="Without menu">Publikasi Ilmiah</div>
                                    </a>
                                </li>
                                <li class="menu-item @yield('menuKepalaStudiLanjut')">
                    ...
                    @elseif(Auth()->user()->level_id == '5')
                        ...
                        <!-- Data Non Akademik -->
                        <li class="menu-item @yield('menuDosenNonAkademik')">
                            <a href="javascript:void(0);" class="menu-link menu-toggle">
                                <i class="menu-icon tf-icons bx bx-qr"></i>
                                <div data-i18n="Layouts">Non Akademik</div>
                            </a>
                            ...
                            <ul class="menu-sub">
                                <li class="menu-item @yield('menuDosenPenelitian')">
                                    <a href="{{ route('dosen-penelitian.index') }}" class="menu-link">
                                        <div data-i18n="Without menu">Data Penelitian</div>
                                    </a>
                                </li>
