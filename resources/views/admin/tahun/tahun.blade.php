        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('data-tahun.index') }}" class="btn btn-primary">
                        <i class="bx bx-left-arrow-alt"></i>
                        Kembali
                    </a>
                    <a href="{{ route('data-tahun.create', $prodis->id) }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($tahuns as $data)
                                <tr>
                                    ...
                                    <td>{{ $data->tahun ?? '-' }}</td>
                                    <td>
                                        <form action="{{ route('data-tahun.destroy', $data->id) }}" method="POST"
                                            class="d-flex flex-wrap">
                                            @csrf
                                            <a href="{{ route('data-tahun.edit', $data->id) }}"
