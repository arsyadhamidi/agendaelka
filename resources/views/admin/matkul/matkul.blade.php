        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('data-matkul.tahun', $tahuns->prodi_id) }}" class="btn btn-primary">
                        <i class="bx bx-left-arrow-alt"></i>
                        Kembali
                    </a>
                    <a href="{{ route('data-matkul.create', $tahuns->id) }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($matkuls as $data)
                                <tr>
                                    ...
                                    <td>{{ $data->matkul ?? '-' }}</td>
                                    <td>
                                        <form action="{{ route('data-matkul.destroy', $data->id) }}" method="POST"
                                            class="d-flex flex-wrap">
                                            @csrf
                                            <a href="{{ route('data-matkul.edit', $data->id) }}"
