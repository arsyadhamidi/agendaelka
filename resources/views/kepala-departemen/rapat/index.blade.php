...
@section('menuKepalaRapat', 'active')
        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('kepala-rapat.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($rapats as $data)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('kepala-rapat.destroy', $data->id) }}" method="POST"
                                            class="d-flex flex-wrap">
                                            @csrf
                                            <a href="{{ route('kepala-rapat.edit', $data->id) }}"
