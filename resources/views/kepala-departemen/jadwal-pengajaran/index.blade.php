        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('kepala-jadwalpengajaran.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($jadwals as $data)
                                <tr>
                                    ...
                                    <td>{{ $data->semester ?? '-' }}</td>
                                    <td>
                                        <form action="{{ route('kepala-jadwalpengajaran.destroy', $data->id) }}"
                                            method="POST" class="d-flex flex-wrap">
                                            @csrf
                                            <a href="{{ route('kepala-jadwalpengajaran.edit', $data->id) }}"
