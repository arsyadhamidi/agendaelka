...
@section('title', 'Data Studi Lanjut | Agenda Elka')
        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('kepala-studilanjut.index') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($tahuns as $data)
                                <tr>
                                    ...
                                    <td>{{ $data->tahun ?? '-' }}</td>
                                    <td>
                                        <a href="{{ route('kepala-studilanjut.studilanjut', $data->id) }}"
