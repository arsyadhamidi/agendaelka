            ...
            <div class="card">
                <div class="card-header d-flex align-content-center justify-content-between">
                    <div class="form-group">
                        <a href="{{ route('dosen-pengabdian.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($pengabdians as $data)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('dosen-pengabdian.destroy', $data->id) }}" method="POST"
                                            class="d-flex flex-wrap">
                                            @csrf
                                            <a href="{{ route('dosen-pengabdian.edit', $data->id) }}"
