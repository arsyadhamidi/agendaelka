        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('dosen-rps.tahun', $tahuns->prodi_id) }}" class="btn btn-primary">
                        <i class="bx bx-left-arrow-alt"></i>
                        Kembali
                    </a>
                    <a href="{{ route('dosen-rps.create', $tahuns->id) }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($rps as $data)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('dosen-rps.destroy', $data->id) }}" method="POST"
                                            class="d-flex flex-wrap">
                                            @csrf
                                            <a href="{{ route('dosen-rps.edit', $data->id) }}"
