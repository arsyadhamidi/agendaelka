...
@section('content')
    <div class="row">
        <div class="col-lg">
            <form action="{{ route('dosen-publikasi.update', $publikasis->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('dosen-publikasi.index') }}" class="btn btn-primary">
        ...
        $(document).ready(function() {
            $('#selectedProdi').on('change', function() {
                ...
                if (prodiId) {
                    ...
                    $.ajax({
                        url: '/dosen-publikasi/tahun/' + prodiId,
                        type: 'GET',
                        dataType: 'json',
