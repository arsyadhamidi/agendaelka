...
@section('menuDosenStudiLanjut', 'active')
            ...
            <div class="card">
                <div class="card-header d-flex align-content-center justify-content-between">
                    <div class="form-group">
                        <a href="{{ route('dosen-studilanjut.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($studis as $data)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('dosen-studilanjut.destroy', $data->id) }}" method="POST"
                                            class="d-flex flex-wrap">
                                            @csrf
                                            <a href="{{ route('dosen-studilanjut.edit', $data->id) }}"
