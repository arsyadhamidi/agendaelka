...
<head>
    ...
    <title>Landing | Agenda Elka</title>
...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex align-items-center">
            ...
            <div class="header-social-links d-flex align-items-center">
                <a href="/login" class="btn-get-started scrollto">Login / Masuk</a>
            </div>
    ...
    <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
        <div class="container text-center text-md-left" data-aos="fade-up">
            <h1>Selamat Datang di <span>Agenda Departemen Teknik ELektronika</span></h1>
            <a href="/login" class="btn-get-started scrollto">Masuk dan Memulai</a>
        </div>
    </section><!-- End Hero -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <img src="{{ asset('images/about.jpg') }}" class="img-fluid"
                            style="width: 600px; height: 450px;object-fit:cover" alt="">
                    </div>
