            ...
            <div class="card">
                <div class="card-header d-flex align-content-center justify-content-between">
                    <div class="form-group">
                        <a href="{{ route('kaprodi-studilanjut.tahun', $tahuns->prodi_id) }}" class="btn btn-primary">
                            <i class="bx bx-left-arrow-alt"></i>
                            Kembali
                        </a>
                    </div>
                    <a href="{{ route('kaprodi-studilanjut.generateexcel', $tahuns->id) }}" class="btn btn-success"
                        target="_blank">
