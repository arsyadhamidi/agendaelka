            ...
            <div class="card">
                <div class="card-header d-flex align-content-center justify-content-between">
                    <div class="form-group">
                        <a href="{{ route('kaprodi-seminar.tahun', $tahuns->prodi_id) }}" class="btn btn-primary">
                            <i class="bx bx-left-arrow-alt"></i>
                            Kembali
                        </a>
                        <a href="{{ route('kaprodi-seminar.create', $tahuns->id) }}" class="btn btn-primary">
                            <i class="bx bx-plus"></i>
                            Tambahkan Data Seminar
                        </a>
                    </div>
                    <a href="{{ route('kaprodi-seminar.generateexcel', $tahuns->id) }}" class="btn btn-success"
                        target="_blank">
                        ...
                        <tbody>
                            @foreach ($seminars as $data)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('kaprodi-seminar.destroy', $data->id) }}" method="POST"
                                            class="d-flex flex-wrap">
                                            @csrf
                                            <a href="{{ route('kaprodi-seminar.edit', $data->id) }}"
