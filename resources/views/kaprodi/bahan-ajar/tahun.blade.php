...
@section('menuKaprodiPengajaran', 'active')
@section('menuKaprodiBahanAjar', 'active')
        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('kaprodi-bahanajar.index') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($tahuns as $data)
                                <tr>
                                    ...
                                    <td>{{ $data->tahun ?? '-' }}</td>
                                    <td>
                                        <a href="{{ route('kaprodi-bahanajar.bahanajar', $data->id) }}"
