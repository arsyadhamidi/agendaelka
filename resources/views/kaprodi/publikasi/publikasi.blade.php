...
@section('menuKaprodiPublikasi', 'active')
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-content-center">
                    <div class="form-group">
                        <a href="{{ route('kaprodi-publikasi.tahun', $tahuns->prodi_id) }}" class="btn btn-primary">
                            <i class="bx bx-left-arrow-alt"></i>
                            Kembali
                        </a>
                    </div>
                    <a href="{{ route('kaprodi-publikasi.generateexcel', $tahuns->id) }}" class="btn btn-success"
                        target="_blank">
