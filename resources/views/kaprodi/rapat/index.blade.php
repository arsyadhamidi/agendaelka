        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('kaprodi-rapat.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($rapats as $data)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('kaprodi-rapat.destroy', $data->id) }}" method="POST"
                                            class="d-flex flex-wrap">
                                            @csrf
                                            <a href="{{ route('kaprodi-rapat.edit', $data->id) }}"
