...
@section('content')
    <div class="row">
        <div class="col-lg">
            <form action="{{ route('mahasiswa-pengabdian.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('mahasiswa-pengabdian.index') }}" class="btn btn-primary">
        ...
        $(document).ready(function() {
            $('#selectedProdi').on('change', function() {
                ...
                if (prodiId) {
                    ...
                    $.ajax({
                        url: '/mahasiswa-pengabdian/tahun/' + prodiId,
                        type: 'GET',
                        dataType: 'json',
