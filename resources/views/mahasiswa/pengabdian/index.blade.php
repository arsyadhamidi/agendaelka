...
@section('menuMahasiswaPengabdian', 'active')
            ...
            <div class="card">
                <div class="card-header d-flex align-content-center justify-content-between">
                    <div class="form-group">
                        <a href="{{ route('mahasiswa-pengabdian.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($pengabdians as $data)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('mahasiswa-pengabdian.destroy', $data->id) }}"
                                            method="POST" class="d-flex flex-wrap">
                                            @csrf
                                            <a href="{{ route('mahasiswa-pengabdian.edit', $data->id) }}"
