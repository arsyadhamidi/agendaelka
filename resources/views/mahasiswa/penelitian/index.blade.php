...
@section('menuMahasiswaPenelitian', 'active')
            ...
            <div class="card">
                <div class="card-header d-flex align-content-center justify-content-between">
                    <div class="form-group">
                        <a href="{{ route('mahasiswa-penelitian.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($penelitians as $data)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('mahasiswa-penelitian.destroy', $data->id) }}"
                                            method="POST" class="d-flex flex-wrap">
                                            @csrf
                                            <a href="{{ route('mahasiswa-penelitian.edit', $data->id) }}"
