...
@section('content')
    <div class="row">
        <div class="col-lg">
            <form action="{{ route('mahasiswa-penelitian.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('mahasiswa-penelitian.index') }}" class="btn btn-primary">
        ...
        $(document).ready(function() {
            $('#selectedProdi').on('change', function() {
                ...
                if (prodiId) {
                    ...
                    $.ajax({
                        url: '/mahasiswa-penelitian/tahun/' + prodiId,
                        type: 'GET',
                        dataType: 'json',
