            ...
            <div class="card">
                <div class="card-header d-flex align-content-center justify-content-between">
                    <div class="form-group">
                        <a href="{{ route('mahasiswa-studilanjut.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($studis as $data)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('mahasiswa-studilanjut.destroy', $data->id) }}"
                                            method="POST" class="d-flex flex-wrap">
                                            @csrf
                                            <a href="{{ route('mahasiswa-studilanjut.edit', $data->id) }}"
