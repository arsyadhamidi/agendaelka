            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-content-center">
                    <div class="form-group">
                        <a href="{{ route('mahasiswa-publikasi.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($publikasis as $data)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('mahasiswa-publikasi.destroy', $data->id) }}" method="POST"
                                            class="d-flex flex-wrap">
                                            @csrf
                                            <a href="{{ route('mahasiswa-publikasi.edit', $data->id) }}"
