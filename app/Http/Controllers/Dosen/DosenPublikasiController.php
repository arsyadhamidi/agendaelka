...
class DosenPublikasiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dosen-publikasi.index')->with('success', 'Selamat ! Anda berhasil menambahkan data');
    }
    ...
    public function edit($id)
    {
        ...
        return view('dosen.publikasi.edit', [
            'prodis' => $prodis,
            'tahuns' => $tahuns,
            'publikasis' => $publikasis,
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('dosen-publikasi.index')->with('success', 'Selamat ! Anda berhasil memperbaharui data');
    }
