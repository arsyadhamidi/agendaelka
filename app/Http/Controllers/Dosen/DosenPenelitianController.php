...
class DosenPenelitianController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dosen-penelitian.index')->with('success', 'Selamat ! Anda berhasil menambahkan data');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('dosen-penelitian.index')->with('success', 'Selamat ! Anda berhasil memperbaharui data');
    }
