...
class AdminJadwalPengajaranController extends Controller
{
    public function index()
    {
        $jadwals = JadwalPengajaran::latest()->get();
        return view('admin.jadwal-pengajaran.index', [
            'jadwals' => $jadwals,
        ]);
    }
    ...
    {
        return view('admin.jadwal-pengajaran.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('data-jadwalpengajaran')->with('success', 'Selamat ! Anda berhasil menambahkan data!');
    }

    public function edit($id)
    {
        $jadwal = JadwalPengajaran::where('id', $id)->first();
        return view('admin.jadwal-pengajaran.edit', [
            'jadwals' => $jadwal,
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('data-jadwalpengajaran')->with('success', 'Selamat ! Anda berhasil memperbaharui data!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('data-jadwalpengajaran')->with('success', 'Selamat ! Anda berhasil menghapus data!');
    }
}
