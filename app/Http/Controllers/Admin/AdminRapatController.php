...
class AdminRapatController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/data-rapat')->with('success', 'Selamat ! Anda berhasil menambahkan data');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/data-rapat')->with('success', 'Selamat ! Anda berhasil memperbaharui data');
    }
    ...
    public function destroy($id)
    {
        $rapats = Rapat::find($id);
        $rapats->delete();
        return redirect('/data-rapat')->with('success', 'Selamat ! Anda berhasil menghapus data');
    }
}
