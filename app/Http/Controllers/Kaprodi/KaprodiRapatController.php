...
class KaprodiRapatController extends Controller
{
    public function index()
    {
        $rapats = Rapat::latest()->get();
        return view('kaprodi.rapat.index', [
            'rapats' => $rapats,
        ]);
    }
    ...
    {
        return view('kaprodi.rapat.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/kaprodi-rapat')->with('success', 'Selamat ! Anda berhasil menambahkan data');
    }

    public function edit($id)
    {
        $rapats = Rapat::find($id);
        return view('kaprodi.rapat.edit', [
            'rapats' => $rapats,
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/kaprodi-rapat')->with('success', 'Selamat ! Anda berhasil memperbaharui data');
    }
    ...
    public function destroy($id)
    {
        $rapats = Rapat::find($id);
        $rapats->delete();
        return redirect('/kaprodi-rapat')->with('success', 'Selamat ! Anda berhasil menghapus data');
    }
}
