...
class KaprodiAkademikController extends Controller
{
    ...
    public function tahun($id)
    {
        ...
        return view('kaprodi.akademik.tahun', [
            'tahuns' => $tahuns,
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('kaprodi-akademik/akademik/' . $request->tahun_id)->with('success', 'Selamat ! Anda berhasil menambahkan data');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('kaprodi-akademik/akademik/' . $request->tahun_id)->with('success', 'Selamat ! Anda berhasil memperbaharui data');
    }
