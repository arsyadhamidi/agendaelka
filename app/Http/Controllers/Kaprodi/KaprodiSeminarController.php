...
class KaprodiSeminarController extends Controller
{
    public function index()
    {
        ...
        return view('kaprodi.seminar.index', [
            'prodis' => $prodis,
        ]);
    }
    ...
    public function tahun($id)
    {
        ...
        return view('kaprodi.seminar.tahun', [
            'tahuns' => $tahuns,
        ]);
    }
    ...
    public function seminar($id)
    {
        ...
        return view('kaprodi.seminar.seminar', [
            'tahuns' => $tahuns,
            'seminars' => $semianrs,
        ]);
    }
    ...
    public function generateexcel($id)
    {
        ...
        return Excel::download(new SeminarExport($data), 'kaprodi-seminar.xlsx');
    }
    ...
    public function create($id)
    {
        ...
        $mahasiswas = Mahasiswa::where('prodi_id', $tahuns->prodi_id)
            ...
            ->latest()
            ->get();
        return view('kaprodi.seminar.create', [
            'tahuns' => $tahuns,
            'dosens' => $dosens,
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('kaprodi-seminar.seminar', $request->tahun_id)->with('success', 'Selamat ! Anda berhasil menambahkan data');
    }
    ...
    public function edit($id)
    {
        ...
        $mahasiswas = Mahasiswa::where('prodi_id', $seminars->prodi_id)
            ...
            ->latest()
            ->get();
        return view('kaprodi.seminar.edit', [
            'dosens' => $dosens,
            'mahasiswas' => $mahasiswas,
            'seminars' => $seminars,
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('kaprodi-seminar.seminar', $request->tahun_id)->with('success', 'Selamat ! Anda berhasil memperbaharui data');
    }
