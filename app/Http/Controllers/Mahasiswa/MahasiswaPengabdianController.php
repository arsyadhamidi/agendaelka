...
class MahasiswaPengabdianController extends Controller
{
    public function index()
    {
        ...
        return view('mahasiswa.pengabdian.index', [
    ...
    public function create()
    {
        ...
        return view('mahasiswa.pengabdian.create', [
            'prodis' => $prodis,
            'tahuns' => $tahuns,
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('mahasiswa-pengabdian.index')->with('success', 'Selamat ! Anda berhasil menambahkan data');
    }
    ...
    public function edit($id)
    {
        ...
        return view('mahasiswa.pengabdian.edit', [
            'prodis' => $prodis,
            'tahuns' => $tahuns,
            'pengabdians' => $pengabdians,
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('mahasiswa-pengabdian.index')->with('success', 'Selamat ! Anda berhasil memperbaharui data');
    }
